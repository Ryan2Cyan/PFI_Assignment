...
namespace Enemy {
    public class EnemyVelocity : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_rigidbody.AddRelativeTorque(new Vector3(Random.Range(m_minRandomTorque, m_maxRandomTorque), 
                Random.Range(m_minRandomTorque, m_maxRandomTorque), Random.Range(m_minRandomTorque, m_maxRandomTorque)));
        }
